...
BigInt::BigInt(const std::string& s) {
    size_t start = 0;
        ...
        else if(s.length() == 1 && s == "0"){sign = 0; for (size_t i = 0; i < 4; ++i){nums.push_back(0);}; return;}
        else {sign = 1;}
...
void BigInt::Delete_Leading_Zeros(){
    size_t need = 0;
    for(size_t i = nums.size() - 1; 2 < i; --i){
        if(nums[i] == 0){++need;}
        else{break;}
    }
...
// int main(){
//     BigInt big1("1234567891011121314151617181920"), big2("-1234567891011121314151617181920"), big3("0");
// //    (big1).Write_In_65536_Binary_System();
//     // big3.Write_In_65536_Binary_System();
//     // big3.Write_In_65536_Binary_System();
//     // big3.Write_In_65536_Binary_System();

// //    std::cout << std::boolalpha << (big2 < big3) << ' ' << (big2 < big3) << ' ' << (big2 < big1) << ' '<< (big1 < big2) << '\n';
//     // (Abs(big1)).Write_In_65536_Binary_System();
//     // (big1).Write_In_65536_Binary_System();
//     // (big3).Write_In_65536_Binary_System();
//     // std::cout << std::boolalpha << (Abs(big1) < Abs(big2)) << (Abs(big2) < Abs(big1));

//     // (big1).Write_In_65536_Binary_System();
//     // (big2).Write_In_65536_Binary_System();

//     // (big1 + big2).Write_In_65536_Binary_System();
//     // (big1 + big3).Write_In_65536_Binary_System();
//     // (big2 + big3).Write_In_65536_Binary_System();
//     (big1 * big3).Write_In_65536_Binary_System();
//     (big2 * big3).Write_In_65536_Binary_System();
//     (big1 * big2).Write_In_65536_Binary_System();
// }
